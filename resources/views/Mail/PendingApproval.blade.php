...
@if ($level == 1)
New UCUA Observation has been created for you to verify.<br>
@else
New UCUA Observation has been created for you to complete.<br>
@endif
Details of the observation are as follow.<br>

URL: <a href="{{ route('ShowSelectedTicket',['category'=>'Pending','ticketId'=>$ticket->id]) }}">{{ $ticket->ticket_id }}</a> <br>
