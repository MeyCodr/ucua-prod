                                    ...
                                    <div class="grid md:grid-cols-3 py-2">
                                        ...
                                        <div class="col-span-2">
                                            <input type="text" name="name" id="name" class="w-full rounded"
                                                placeholder="Name"
                                                value="{{ $formType == 'Edit' ? $plant->name : old('name') }}"
                                                required>
                                            @error('name')
                                    ...
                                    <div class="grid md:grid-cols-3 py-2">
                                        ...
                                        <div class="col-span-2">
                                            <input type="text" name="short_name" id="short_name" class="w-full rounded"
                                                ...
                                                value="{{ $formType == 'Edit' ? $plant->short_name : old('short_name') }}"
                                                required>
                                            @error('short_name')
                                                <span class="text-red-600">* {{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="grid md:grid-cols-3 py-2">
                                        ...
                                        <select name="user_head_id" id="user_head_id" class="col-span-2 w-full rounded"
                                            ...
                                            @forelse ($head_plants as $item)
                                                ...
                                                @else
                                                    <option value="{{ $item->id }}"
                                                        @if ($plant->user_head_id == $item->id) selected @endif>
                                                        {{ $item->name }}</option>
                                                @endif
                                            @empty
                                                No Data
