                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-2">
                            <div class="p-6 bg-white border-b border-gray-200">
                                <div>
                                    <div class="grid md:grid-cols-3 py-2">
                                        ...
                                        <div class="col-span-2">
                                            <input type="text" name="name" id="name" class="w-full rounded"
                                                placeholder="Name"
                                                value="{{ $formType == 'Edit' ? $subdepartment->name : old('name') }}"
                                                required>
                                            @error('name')
                                    ...
                                    <div class="grid md:grid-cols-3 py-2">
                                        ...
                                        <div class="col-span-2">
                                            <input type="text" name="short_name" id="short_name" class="w-full rounded"
                                                ...
                                                value="{{ $formType == 'Edit' ? $subdepartment->short_name : old('short_name') }}"
                                                required>
                                            @error('short_name')
                                                <span class="text-red-600">* {{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="grid md:grid-cols-3 py-2">
                                        <label for="user_head_id" class="col-span-1 self-center">Head of Sub Department: <span
                                                class="text-red-600">*</span></label>
                                        <select name="user_head_id" id="user_head_id" class="col-span-2 w-full rounded"
                                            ...
                                            @forelse ($head_subdepartments as $item)
                                                @if ($formType == 'New')
                                                ...
                                                @else
                                                    <option value="{{ $item->id }}"
                                                        @if ($subdepartment->user_head_id == $item->id) selected @endif>
                                                        {{ $item->name }}</option>
                                                @endif
                                            @empty
                                                No Data
