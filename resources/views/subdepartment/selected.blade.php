            ...
            <div class="flex justify-start">
                ...
                <div>
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                        Sub Department #{{ $subdepartment->id }}
                    </h2>
                </div>
            </div>
            <div class="text-right">
                <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded"
                    href="{{ route('SubDepartment.edit', ['div_id' => $div_id, 'dept_id' => $dept_id, 'SubDepartment' => $subdepartment->id]) }}">Edit</a>
            </div>
        </div>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <div>
                                @if ($subdepartment->user_head_id)
                                    <ul class="list-disc">
                                        <li>{{ $subdepartment->head_subdepartment->name }}</li>
                                        <li>{{ $subdepartment->head_subdepartment->email }}</li>
                                    </ul>
                                @else
    ...
    <div class="fixed z-10 inset-0 overflow-y-auto modalDeleteAccLink hidden" role="dialog">
        <div class="flex items-end justify-center min-h-screen pt-1 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <form
                    action="{{ route('SubDepartment.destroy', ['div_id' => $div_id, 'dept_id' => $dept_id, 'SubDepartment' => $subdepartment->id]) }}"
                            ...
                            <div class="mt-1 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-gray-500">
                                        You are about to delete this subdepartment. Continue?
                                    </p>
                                </div>
                                <div class="mt-2">
                                    <input type="text" name="subdepartment_id" value="{{ $subdepartment->id }}" hidden>
                                </div>
                            </div>
                        </div>
                    </div>
