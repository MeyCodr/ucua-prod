                ...
                <div class="ml-3 relative">
                    <x-dropdown align="right">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('User.create')" onclick="">
                                New User
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                ...
                <form action="">
                    <div class="text-right">
                        <input type="text" name="name" class=" br-5 border-gray-300 rounded-md"
                            style="height: 30px;" placeholder="search name...">
                        or
                        <input type="email" name="email" class=" br-5 border-gray-300 rounded-md"
                            style="height: 30px;" placeholder="search email...">
                        <button type="submit"
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col gap-y-1.5">
                @forelse ($users as $item)
                    <a href="{{ route('User.show', ['User' => $item->id, 'pageNum' => $pageNum]) }}">
                        <div
